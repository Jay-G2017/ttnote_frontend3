      ...
      <HomeBody>
        <HomePaddingContainer>
          <BodyContent>
            ...
            {/*</p>*/}
            <p>
              我接触蕃茄工作法是两年多前的事了。两年多前我从一个机械工程师变成了一个整天写代码的“码农小哥”。常常会感觉工作很忙，但回头想想好像也没有什么很
              重要的事情;
            ...
            <p>
              我开始觉得记录和规划时间是一件很重要事情。就像财务管理公司的资产一样，财务记录公司的资产和收支，规避风险，为公司成长提供数据的支撑。对于一个个人来说时间就是
              我们最重要的隐形资产，我得好好学着如何经营它们。
            </p>
            ...
            <p>新的一年，祝大家蕃茄快乐<span role={'img'}>🍅</span></p>
